...
<div class="text-center col-xs-12">
  ...
  <div>
    <div class="col-xs-4">
      <a href='javascript:foodLoad("tomato-underripe")' style="cursor: pointer;">
        <img src="" alt="Underripe Tomato" />
        <div>Underripe Recipes</div>
      </a>
    </div>
    <div class="col-xs-4">
      <a href='javascript:foodLoad("tomato-ripe")' style="cursor: pointer;">
        <img src="images/Tomato.png" alt="Ripe Tomato" />
        <div>Ripe Tomato Recipes</div>
      </a>
    </div>
    <div class="col-xs-4">
      <a href='javascript:foodLoad("tomato-overripe")' style="cursor: pointer;">
        <img src="" alt="Overripe Tomato" />
        <div>Overripe Tomato Recipes</div>
      </a>
    </div>
  </div>
</div>
